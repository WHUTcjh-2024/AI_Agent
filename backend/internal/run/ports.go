...
type Repository interface {
	...
	CompleteAssistantMessage(ctx context.Context, userID string, message domain.Message, sources []domain.Source, citations []domain.Citation) (domain.Message, error)
